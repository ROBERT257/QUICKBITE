...
import { FiPlus, FiEdit2, FiTrash2, FiSearch, FiFilter, FiUpload, FiImage, FiDollarSign, FiClock, FiStar, FiCheck, FiX, FiTrendingUp, FiPackage, FiUsers, FiShoppingCart, FiSettings, FiLogOut, FiGrid, FiList, FiDownload, FiRefreshCw, FiEye, FiEyeOff, FiCopy, FiMove, FiTag, FiTruck, FiMapPin, FiPhone, FiUser, FiLock } from 'react-icons/fi';
        ...
        <div className="max-w-7xl mx-auto">
                ...
                <div className="premium-card p-4 hover:scale-105 transition-transform">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-neon-green">KSh {stats.totalRevenue.toLocaleString()}</p>
                    </div>
                    <div className="w-10 h-10 bg-gradient-to-br from-green-500 to-emerald-500 rounded-lg flex items-center justify-center animate-pulse">
                ...
                <div className="premium-card overflow-hidden">
                  <div className="overflow-x-auto">
                    <table className="w-full">
                      <thead>
                        <tr className="border-b border-white/10">
                          <th className="text-left p-4 text-white/70">Order ID</th>
                          <th className="text-left p-4 text-white/70">Customer</th>
                          <th className="text-left p-4 text-white/70">Items</th>
                          <th className="text-left p-4 text-white/70">Total</th>
                          <th className="text-left p-4 text-white/70">Status</th>
                      ...
                      <tbody>
                        {orders.map((order, index) => (
                          ...
                          >
                            ...
                            <td className="p-4">
                              <div>
                                <h4 className="text-white font-medium">{order.customer_name}</h4>
                                <div className="flex items-center space-x-2 text-white/60 text-sm">
                            ...
                            <td className="p-4">
                              <span className="text-neon-green font-bold">KSh {order.total_amount}</span>
                            </td>
                            <td className="p-4">
                              <div className="flex items-center space-x-2">
                            ...
                            <td className="p-4">
                              <div className="text-white/70 text-sm">
                                {order.delivery_time ? new Date(order.delivery_time).toLocaleString() : 'Not set'}
                              </div>
                            </td>
                            <td className="p-4">
                              <div className="flex space-x-2">
          ...
          {activeTab === 'stats' && (
            <>
              ...
              <div className="premium-card p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-green-400 font-bold text-lg">{stats.available}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-white/70">Featured Items</span>
                    <span className="text-purple-400 font-bold text-lg">{stats.featured}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-white/70">Categories</span>
                    <span className="text-orange-400 font-bold text-lg">{stats.categories}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="premium-card p-6">
                <h3 className="text-xl font-bold text-white mb-4 flex items-center">
                  <FiDollarSign className="w-6 h-6 mr-2 text-neon-green" />
                  Financial Overview
                </h3>
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
          ...
          >
            <div className="p-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                {/* Image Field and Submit Buttons at Top */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-white/70 mb-2 font-medium">Item Image</label>
                ...
                <div className="border-t border-white/10 pt-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-white/70 mb-2 font-medium">Item Name *</label>
                    <input
                      type="text"
                      value={formData.name}
                  ...
                  <div>
                    ...
                    {categories.length === 0 ? (
                      <div className="glass-input w-full px-4 py-3 text-white/50">
                        Loading categories...
                      </div>
                    ) : (
                      <select
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div>
                    <label className="block text-white/70 mb-2 font-medium">Price (KSh) *</label>
                    <input
                      type="number"
                  ...
                  <div>
                    <label className="block text-white/70 mb-2 font-medium">Prep Time (min) *</label>
                    <input
                      type="number"
                  ...
                  <div>
                    <label className="block text-white/70 mb-2 font-medium">Spice Level</label>
                    <select
                    ...
                    >
                      ...
                      <option value={5}>🌶️🌶️🌶️🌶️🌶️ Extra Hot</option>
                    </select>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <label className="flex items-center space-x-3 cursor-pointer">
                      ...
                      />
                      <span className="text-white/70 font-medium">Available for order</span>
                    </label>
